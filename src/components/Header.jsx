...
const Header = () => {
    const auth = useAuth()
  return (
    <Navbar expand="md" className="bg-body-tertiary px-5 d-flex justify-content-between my-header">
      <Container fluid className='d-flex justify-content-between'>
        <Navbar.Brand href="#home" className='fw-bold text-white' style={{fontSize: "30px"}}>DOANTOTNGHIEP</Navbar.Brand>
